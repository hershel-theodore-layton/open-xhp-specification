...
final class GivenAnXHPObjectWithDeclaredAttributesAndSpecialAttributesSetTest
  ...
  protected static function typeUnderTestSpecialLast(): this::TypeUnderTest {
    return
      <tag:herp_and_derp
        herp="h"
        derp={5.5}
  ...
  protected static function typeUnderTestSpecialNotLast(): this::TypeUnderTest {
    return
      <tag:herp_and_derp
        herp="h"
        data-special="special"
  ...
  ): tag\herp_without_default_and_derp_defaulted {
